  ...
  <div class="wrap">
    ...
    <div class="bg-white p-8 rounded shadow-md">
      ...
      <div class="flex justify-end mb-4">
        <a href="<?php echo admin_url('admin.php?page=' . FINANCIALOO_PREFIX . 'expense_categories&add=new') ?>" class="bg-blue-500 hover:bg-white-700 text-white font-bold py-2 px-4 rounded">Add New</a>
      </div>
      ...
      <div class="relative overflow-x-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            ...
            <?php
            global $wpdb;
            $table_name = $wpdb->prefix . FINANCIALOO_PREFIX . 'expense_categories';
            ...
            ?>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                  ...
                  <a href="<?php echo admin_url('admin.php?page=' . FINANCIALOO_PREFIX . 'expense_categories&action=edit&id=' . $result->id) ?>" class="text-blue-600 hover:text-blue-900">Edit</a>
