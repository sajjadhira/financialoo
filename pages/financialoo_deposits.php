...
?>
  <div class="wrap">
    ...
    <div class="bg-white p-8 rounded shadow-md">
      ...
      <?php
      if ($action == "form") {
        include FINANCIALOO_PLUGIN_DIR . '/pages/partials/deposits/form.php';
      } else if ($action == "delete") {
        include FINANCIALOO_PLUGIN_DIR . '/pages/partials/deposits/delete.php';
      } else {
